...
For a recorded demo, capture the Overview page first, then move through
New Claim, Claim Details, Human Review, and Policy Assistant. Use only
...
- backend health,
- the consolidated assessment recommendation,
- the audit log,
- the disclaimer that this is decision support, not automatic claim
